...
# ==========================================
# Link Hosting Kalian
wisnuvpn="raw.githubusercontent.com/anzclan/scwsl/main/websocket"
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://raw.githubusercontent.com/anzclan/scwsl/main/ssh/ws-nontls.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/anzclan/scwsl/main/ssh/ws-ovpn.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ovpn-tls https://raw.githubusercontent.com/anzclan/scwsl/main/ssh/ovpn-tls.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://raw.githubusercontent.com/anzclan/scwsl/main/ssh/ws-tls.py
